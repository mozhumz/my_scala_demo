...
//      .selectExpr("*")
    ...
    //    weights : [-0.01623261812237973,-0.01705715241719569,4.75002368381124E-4,-0.008066900402337377,
    //    0.03201556250886345,9.126310752565968E-7,1.6691532815019365,5.62221181248999E-7] intercept : -2.3711237931175457
    //    收集日志
    ...
    /**
      ...
      * +--------------------+--------------------+
      * |                 0.0|                 0.0|
      * |0.003493257908056...|0.013637886684296533|
      * |0.007549205902899497|0.026671615400873247|
      * |0.012367962452829628| 0.04113326013330653|
      * |0.016043937223248636| 0.05154415972039652|
      * |0.020468181049055813|   0.064156215043121|
      * | 0.02496191681437043| 0.07649299702560454|
      * |0.030283144735796682| 0.09060926134987035|
      * | 0.03484122064938672| 0.10233466846058281|
      * |  0.0385681409108779| 0.11176716205558047|
      * |0.043212537948666634| 0.12302759434813314|
      * | 0.04772253047742451| 0.13396842088984426|
      * | 0.05260345197488765| 0.14553918005660116|
      * | 0.05667680157566962|  0.1549077525014305|
      * | 0.06141026735964746| 0.16610735660269396|
      * | 0.06545179033904053| 0.17508930918763435|
      * | 0.06955937073045301| 0.18422487873023727|
      * | 0.07349179021997691| 0.19287382274252665|
      * |  0.0785612672765319| 0.20382495914716814|
      * | 0.08227971570355265|  0.2117099423163169|
      * +--------------------+--------------------+
      */
